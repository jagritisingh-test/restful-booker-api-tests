...
[![API Tests](https://github.com/YOUR-USERNAME/restful-booker-api-tests/actions/workflows/api-tests.yml/badge.svg)](https://github.com/YOUR-USERNAME/restful-booker-api-tests/actions/workflows/api-tests.yml)
...
Feel free to fork this, point it at a different public API, or extend it with more edge cases — contributions and suggestions welcome.
